...
from polylearn.kernels import safe_power


class RandomKernelSignedCirculant(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None):
        ...
        self.Projs = fft(random_state.randint(2, size=(self.t, d))*2-1)
        self.Signs = random_state.randint(2, size=(self.t, d))*2-1
        return self
    ...
    def transform(self, raw_X):
        ...
        for proj, sign in zip(self.Projs, self.Signs):
